...
class Settings:
        ...
        def populate(self, options):
                ...
                if options.Interface is None and utils.IsOsX() is False:
                        print ("Error: -I <if> mandatory option is missing", 1)
                        sys.exit(-1)
                ...
                if not os.path.exists(self.Html_Filename):
                        print (r"/!\ Warning: %s: file not found" % self.Html_Filename, 3, 1)

                if not os.path.exists(self.Exe_Filename):
                        print (r"/!\ Warning: %s: file not found" % self.Exe_Filename, 3, 1)
